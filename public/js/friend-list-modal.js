...
async function getFriendRequestList() {
    ...
    for (const friendRequest of data.data) {
        ...
        acceptButton.addEventListener("click", async () => {
            await acceptFriendRequest(friendRequest.id, friendRequestDiv);
        });
        ...
        denyButton.addEventListener("click", async () => {
            await rejectFriendRequest(friendRequest.id, friendRequestDiv);
        });
...
async function acceptFriendRequest(senderId, friendRequestDiv) {
    try {
...
async function rejectFriendRequest(senderId, friendRequestDiv) {
    try {
